...
public class ProductIntoDBManager implements IProductIntoDBManager {
	...
	/*
	 * (non-Javadoc)
	 * @see com.enation.app.shop.order.manager.IProductIntoDBManager#rollbackProductDB(com.enation.app.shop.trade.model.vo.Order, java.util.List)
	 */
	@Override
	public void rollbackProductDB(Order order, List<Product> productList) {
